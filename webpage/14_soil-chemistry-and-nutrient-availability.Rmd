...
Cation exchange capacity and total exchangeable base cations can be determined using the most common method of Brown (1943), for which 1 M buffer ammonium acetate solution (NH~4~Ac) at pH 7 serves as the extractant. Soil samples are collected and sieved (< 2 mm) and air dried.
