...
```{r photoS2, fig.cap="Point-intercept survey in climate change experimental plots. Photos: Inger Kappel Schmidt (top left to bottom left) and Alwyn Sowerby (bottom right)."}
