...
tribble(
    ...
    "Site (selection)", "What does the system represent?", "Sites should be placed within the limits of the relevant system, avoiding off-site effects when possible. Please note if former land use only affects part of the study area",
    "", "Which environment, habitat, ecosystem, former and present land use?", "Blocks (or other study design features) should be chosen to capture within-site heterogeneity due to environmental or biotic variability, or off-site effects.",
    "", "Are there any specific factors like off-site effects (run-off, shade, nutrient inputs etc.) to consider?", "",
    "", "Single-site or multi-site study?", "**Single-site studies** are easier and cheaper to maintain, allowing resources to be spent on experimental factors and response variables.",
    "", "Is the interest in the treatment effects per se, or across site comparisons of these effects?", "**Multiple-site studies** allow across site comparisons, but it is then important to consider your “outer design”, i.e. should sites be along gradients or replicates in similar environmental settings, how many replicates are needed (e.g. to fit a regression at site level), etc.",
    "", "Are there other reasons for replicating across sites such as generality of the response, relevance across several systems etc.?", "Multi-site studies increase the costs and effort, but these also depend on the study and location of the different sites.",
    "", "Are any **permits** necessary and contacts to ensure site sustainability?", "Obtain permits from the government and landowners well in advance.", 
    "", "", "Ideally get permits beyond the funding period for potential extension of the study.", 
    "", "Is any site-scale **maintenance** needed? Fencing, grazing, mowing?", "Building a fence and moving might need the agreement of the landowner.", 
    "", "Any control needed for that?", "Calculate enough time and money for maintenance.", 
    "", "", "If the site maintenance affects your responses, you might need (yet) another set of controls.", 
    "", "What **site-scale data** are needed?", "Report all the information needed to situate your study in space, time, and in the relevant ecological context. If you have a heterogeneous system, you likely need more than one measuring point in space (horizontal and vertical) and time.",
    "", "How many measurements are needed?", "Any variables affected by the experimental treatments need monitoring on a finer scale (see below)",
    "", "", "Draw detailed maps of your study site with all blocks, plots, and installations clearly indicated",
   ...
   "Within-site study design (blocks)", "How to ensure **sustainable site set-up**?", "The area should be large enough to accommodate the study, treatments and the necessary unmanipulated controls / sampling areas for site-level factors.",
   ...
   "Within-block study design (plots)", "How to ensure **sustainability of studies in plot set-up**?", "Plots should be large enough to encompass the responses of interest, and thus have to match the study aim and study system. The plot size should also take into account the complexity and heterogeneity of the study system (De Boeck et al., 2015). Plots should be large enough for sensor installation and sampling.",
   "", "Where are data measured permanently and where destructively?", "It is recommended to divide the plots into destructive and non-destructive sampling areas.",
   ...
   "", "What **plot-scale data** are needed?", "All variables that are **directly affected by a treatments** should be measured at the plot scale.",
   ...
   "Within-plot study design (sub-plot, sample)", "Where are data measured **permanently** and where **destructively**?", "Sub-plots can be used for dividing plots into zones, for **destructive, non-destructive sampling**.",
  ...
  kbl(booktabs = TRUE,
      escape = FALSE,
      caption = "Checklist of questions to ask and guidance when setting up a sustainable and multi-purpose climate-change study from site to sub-plot level.") %>%
  column_spec(1, bold = TRUE) %>%
  column_spec(2, italic = TRUE) %>%
  #kable_paper("striped", full_width = F) %>%
  #pack_rows("Site (selection)", 1, 5) |>
  #pack_rows("Within-site study design (blocks)", 3, 3) |>
