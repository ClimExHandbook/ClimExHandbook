...
```{r photoS4-1, out.width='60%'}
knitr::include_graphics("http://climexhandbook.w.uib.no/files/2019/11/Demography-1-300x181.png")
```
...
```{r photoS4-2, out.width='60%'}
knitr::include_graphics("http://climexhandbook.w.uib.no/files/2019/11/4.7.1-300x287.png")
```
