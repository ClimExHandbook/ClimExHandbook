...
```{r photoS3, out.width='30%', fig.cap="Measurements of water drop penetration time. Photo: Francis Parry.", out.extra='style="float:right; padding:10px"'}
knitr::include_graphics("http://climexhandbook.w.uib.no/files/2019/11/waterdrop2-300x221.png")
```
